...
<body>
    ...
    <button class="tab-btn tab-btn1">Tab 1</button>
    <button class="tab-btn tab-btn2">Tab 2</button>
    <button class="tab-btn tab-btn3">Tab 3</button>

    <div class="data-section tab-data1">
        <h3>Tab data 1</h3>
    ...
    <div class="data-section tab-data2" style="display:none;">
        <h3>Tab data 2</h3>
        <p>t is a long established fact that a reader will be distracted by the readable content of a page when looking
    ...
    <div class="data-section tab-data3" style="display:none;">
        <h3>Tab data 3</h3>
